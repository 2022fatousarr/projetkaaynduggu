    ...
    <section 
      ...
      <div className="absolute grid grid-cols-2 gap-4 h-full w-full items-center">
          ...
          <div className=" flex flex-col   justify-center items-start">
           <p className="  text-5xl font-bold text-black pl-20  ">Deal Of The Weekend</p>
           <p className="text-xl font-semibold text-black pl-20 pt-10">Découvrez nos offres spéciales ce weekend !</p>
